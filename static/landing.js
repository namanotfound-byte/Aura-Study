 ...
 * animation-delay values (cover hold 1s, tagline at ~6.35s, legal at ~7.25s + 0.55s = 7.8s).
...
(function () {
  ...
  var TOTAL_ANIMATION_MS = 7700; // cover hold + book open + slow settle + hero reveal + tagline/CTA fade-in
