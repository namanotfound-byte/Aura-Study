...
def test_timer_colors_on_timer_view_not_appearance_theme_in_settings():
    ...
    assert '/static/landing.css?v=20260926' in landing_html
    assert '/static/landing.js?v=20260926' in landing_html
    ...
    assert "TOTAL_ANIMATION_MS = 8450" in landing_js
