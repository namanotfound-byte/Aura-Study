...
def _register_page_routes(app: flask.Flask) -> None:
    ...
    # log. Non-owner (or anyone at all when OWNER_EMAIL isn't set) gets a
    # plain 404, never a 403 or a redirect that would confirm the route
    # exists. Query/write logic lives in server/admin.py and
