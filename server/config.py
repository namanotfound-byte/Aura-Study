...
class Config(object):
    ...
    def __init__(self):
        ...
        # it once here rather than at every comparison site. Left empty on
        # purpose is a valid, supported state -- it must make admin pages
        # unreachable for everyone (see server/app.py's owner check), never
        # fall open to "no owner configured means anyone can view it".
